...
angular
    .module('app.core')
    .controller('ProjectsPhotosDetailsController', function($scope, $http, $routeParams, $rootScope, $route, $ionicModal, $location, ionicToast) {
    	$rootScope.noShow = false;
  		$http.get('http://gesso-back.dev/api/photos/'+$routeParams.id).then(function(data){
  			console.log(data.data);
  			$scope.photoDetails = data.data[0];

  			$scope.delete = function(){
  				$http.delete('http://gesso-back.dev/api/photos/'+$routeParams.id+'/delete',
